	...
	<div class="row">
		...
		<?php endif; ?>
			...
			<div class="badge-list">
				<a class="badge" href="<?php echo get_post_type_archive_link('blog').'?meta_key=entreprise_blog&meta_value='.urlencode($societe->ID); ?>"><?= !empty($societe) ? $societe->post_title : "" ?></a>
