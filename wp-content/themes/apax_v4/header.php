						...
						<div class="col-md-12">
							...
							<nav class="wrap_search">
								...
								<div id="header-social">
									...
									<a id="header-linkedin" href="https://www.linkedin.com/company/apax-partners-mid-market" target="_blank"><img src="<?php bloginfo("template_url"); ?>/img/social/linkedin_header<?= $cpl ?>.svg" alt="LinkedIn" /></a>
