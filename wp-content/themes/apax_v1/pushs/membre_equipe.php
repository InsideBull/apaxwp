...
if ($team && count($team)>0) {
	...
	foreach ($team as $t): ?>
		...
		<?php if (has_term(array(29,30), "post_tag", $t->ID)): ?>
		...
		<a href="<?php echo get_permalink($t->ID); ?>" class="bloc-ele block-push block-push-membre-equipe" style="<?php echo $thumb ? 'background-image: url('.$thumb[0].');' : ''; ?>">
